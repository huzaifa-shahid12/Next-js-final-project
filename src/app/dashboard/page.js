...
import PostCard from "../cards/page";
  ...
  return (
    <>
      <div className="flex">
        ...
        transition-transform
        duration-200 ease-out"
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTka8nD-jFC5lrG8iDKcfcfnpj9Pf3HU-RPtQEkx2eAvJAy93gdIxI0-oGjDRSTwplfwyQ&usqp=CAU"
              alt=""
            />
          </div>
          <div className="flex items-center justify-evenly">
            <p className="text-xs w-14 truncate text-center">User 1</p>
            <p className="text-xs w-14 truncate text-center">User 2</p>
            <p className="text-xs w-14 truncate text-center">User 3</p>
            <p className="text-xs w-14 truncate text-center">User 4</p>
            <p className="text-xs w-14 truncate text-center">User 5</p>
            <p className="text-xs w-14 truncate text-center">User 6</p>
            <p className="text-xs w-14 truncate text-center">User 7</p>
            <p className="text-xs w-14 truncate text-center">User 8</p>
            <p className="text-xs w-14 truncate text-center">User 9</p>
          </div>
